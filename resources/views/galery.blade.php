<div class="container" id="app_galery">
  <div class="row">
    <div class="col-md-8 mx-auto">
      <h2 class="section-heading">Discover what all the buzz is about!</h2>
      <p>
        <select v-model="selectCategorie">
            <option value="all">Tous</option>
            <option v-for="categorie in categories" v-bind:value="categorie.id">@{{categorie.libel}}</option>
        </select>
        
        <select v-model="selectAlbum">
            <option value="all">Tous</option>
            <option v-for="album in albums" v-bind:value="album.id">@{{album.libel}}</option>
        </select>
      </p>
